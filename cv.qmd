...
* Email:    [amelia.bridges@plymouth.ac.uk](amelia.bridges@plymouth.ac.uk) or [ameliabridges@hotmail.co.uk](ameliabridges@hotmail.co.uk)
* Tel:      (+44)7926 091 345
...
* High-level ability to manipulate spatial data using GIS softwares 
* Experience working on a Linux-based High Performance Computing system to undertake spatial and statistical analysis
* Application of artificial intelligence to marine imagery for object detection and identification 

## Publications:

McQuaid, K.A., **Bridges, A.E.H.**, Howell, K.L., [et al]. *In press*. Broad-scale benthic habitat classification of the South Atlantic. *Progress in Oceanography*.

**Bridges, A.E.**, Howell, K.L., [et al]. *In press*. Review of the Central and South Atlantic Shelf and Deep-Sea Benthos: Science, Policy and Management. *Oceanography and Marine Biology: An Annual Review*.

Howell, K.L., **Bridges, A.E.H.**, Davies, J., Parimbelli, A., Piechaud, N. 2023. An Ecologist’s Guide to BIIGLE. *University of Plymouth*. 46pp. [DOI: 10.5281/zenodo.7728927](https://zenodo.org/record/7728927#.ZBgWU-zP1WN)

Graves, K.P., **Bridges, A.E.**, Dabrowski, T., Furey, T., Lyons, K., Howell, K.L. 2022. Oceanographic variability drives the distribution but not the density of the aggregation forming deep-sea sponge *Pheronema carpenteri*. *Deep Sea Research Part I: Oceanographic Research Papers*. [DOI:10.1016/j.dsr.2022.103917](https://www.sciencedirect.com/science/article/pii/S0967063722002291?via%3Dihub#fig1)

Howell, K.L., **Bridges, A.E.**, Graves, K.P., Allcock, L., la Bianca, G., Ventura-Costa, C., Donaldson, S.E., Downie, A., Furey, T., McGrath, F., Ross, R.E. 2022. Performance of deep-sea habitat suitability models assessed using independent data, and implications for use in area-based management. *Marine Environmental Progress Series*. [DOI: 10.3354/meps14098](https://www.int-res.com/abstracts/meps/v695/p33-51/)
...
### 2023
* **Invited seminar**: University of Newcastle, UK, “Mapping the Deep: Using Ecology to Support Sustainable Management"
* **Invited keynote**: PlyMSEF Conference 2023, Plymouth, UK, “Mapping the Deep: Using Ecology to Support Sustainable Management"
...
* **Oral presentation**: PlyMSEF Conference 2019, Plymouth, UK, “Defining benthic assemblages of conservation interest (VMEs) in South Atlantic UK Overseas Territories”
